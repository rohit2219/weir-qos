...
constexpr inline int DEFAULT_REDIS_STS_QOS_TTL =
    3; // Increase it slightly as there are more data intensive ops in STS-QoS and
...
constexpr inline int DEFAULT_MSG_QUEUE_SIZE =
    2048; // Increase as a precautionary measure to accomodate more STS Tokens traffic.
